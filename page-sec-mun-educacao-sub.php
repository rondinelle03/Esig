 <?php
  ...
  /* Template Name: Secretarias Municipais de Educação SUB */
  get_header();
?>
			...
			<div class="row">
				<div class="col s12 m6 l8">
					...
					<ul class="migalhas">
						...
						<li><span><a href="<?php bloginfo('url'); ?>/educacao/secretarias-municipais-de-educacao">Secretarias Municipais de Educação</a></span> </li>
